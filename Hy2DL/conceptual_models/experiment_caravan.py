...
if __name__ == "__main__":
    ...
    path_entities = "../../data/basin_id/basins_caravan_testde1"
    path_data = "../../data/Caravan"
    input_variables = ['total_precipitation_sum','potential_evaporation_sum', 'temperature_2m_mean',]
    target_variables = ["streamflow"]
    training_period = ["1980-10-01", "1997-12-31"]
    testing_period = ["1997-01-01", "2016-12-31"]
    batch_size = 15
    warmup_period = 365
    random_seed = 42

    # Save results
    path_output = "../results/conceptual_models_CARAVAN/"
